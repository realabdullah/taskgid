...
<template>
	<dl class="border-border divide-border divide-y overflow-hidden rounded-lg border px-4">
		<div class="grid grid-cols-[5.5rem_minmax(0,1fr)] gap-4 py-4">
			<dt class="text-text-tertiary font-mono text-xs font-semibold tracking-[0.1em] uppercase">Status</dt>
			<dd><BadgeStatus :status="props.task.status" /></dd>
		</div>

		<div class="grid grid-cols-[5.5rem_minmax(0,1fr)] gap-4 py-4">
			<dt class="text-text-tertiary font-mono text-xs font-semibold tracking-[0.1em] uppercase">Priority</dt>
			<dd><BadgePriority :priority="props.task.priority" /></dd>
		</div>

		<div class="grid grid-cols-[5.5rem_minmax(0,1fr)] gap-4 py-4">
			<dt class="text-text-tertiary font-mono text-xs font-semibold tracking-[0.1em] uppercase">Due</dt>
		...
		<div class="grid grid-cols-[5.5rem_minmax(0,1fr)] gap-4 py-4">
			<dt class="text-text-tertiary font-mono text-xs font-semibold tracking-[0.1em] uppercase">Assignees</dt>
