...
<template>
	<NuxtLayout name="dashboard">
		<div class="task-page">
			...
			<nuxt-link :to="`/dashboard/${activeWorkspace}/tasks`" class="back">
			...
			<div class="task-card">
				<div class="task-card__detail">
					...
					<div class="ctas">
						<BaseButton v-if="task.status === 'Pending'" class="btn" value="Work on it Now" background="#3754DB" color="#FFFFFF" width="180px" />
						<BaseButton v-else-if="task.status === 'In Progress'" class="btn" value="Mark As Done" background="#00C271" color="#FFFFFF" width="180px" />
		...
		<!-- UPDATE TASK MODAL -->
		<TasksCreate v-if="showUpdateTaskModal" usage="update" :task-to-be-updated="task" @close="updateTask" />
