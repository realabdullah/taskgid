...
<template>
	<div class="relative container flex min-h-screen flex-col items-center justify-center">
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			<div class="flex flex-col space-y-2 text-center">
				...
				<p class="text-muted-foreground text-sm">Enter your email to receive a password reset link</p>
			</div>

			<div class="grid gap-4">
				<AuthFormField id="email" label="Email" type="email" placeholder="name@example.com" required />

				<Button class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700"> Send Reset Link </Button>
