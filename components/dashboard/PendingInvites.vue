...
<template>
	<Card v-if="invitations && invitations.length" class="mb-6 border-red-200 bg-red-50 dark:border-red-900/50 dark:bg-red-900/10">
		<CardHeader>
		...
		<CardContent>
			<div class="space-y-4">
				<div v-for="(invitation, index) in invitations" :key="index" class="flex items-center justify-between rounded-lg border p-4">
					<div>
						...
						<div class="mt-1 flex items-center gap-2 text-sm">
							...
							<span>•</span>
							<Badge variant="outline">{{ invitation.invitedBy.isAdmin ? "Admin" : "Member" }}</Badge>
							<span>•</span>
